...
const ComplianceComparisonModal: React.FC<ComplianceComparisonModalProps> = ({
  ...
  const { data: comparison, isLoading } = useQuery({
    queryKey: ['client-compliance-comparison', auditId],
    queryFn: () => clientService.getComplianceComparison(auditId),
    enabled: open,
  });
  ...
  if (isLoading) {
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[80vh] flex items-center justify-center border-none shadow-2xl">
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="p-5 bg-muted/20 rounded-2xl border border-muted/10 relative overflow-hidden group">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Prior Engagement</p>
            ...
            <div className={cn(
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Performance Shift</p>
            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent border-muted/10">
                  ...
                  <TableHead className="text-[10px] font-black uppercase tracking-widest text-center py-4 text-muted-foreground">Prior Score</TableHead>
                  <TableHead className="text-[10px] font-black uppercase tracking-widest text-center py-4 text-muted-foreground">Recent Score</TableHead>
                  <TableHead className="text-[10px] font-black uppercase tracking-widest text-right py-4 pr-6 text-muted-foreground">Shift</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
