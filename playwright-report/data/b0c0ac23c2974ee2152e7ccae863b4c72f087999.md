...
- Name: 01-auth.spec.ts >> Authentication & Role Gating >> Unauthenticated user is redirected to login
- Location: e2e\01-auth.spec.ts:27:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5173/admin/dashboard
Call log:
  - navigating to "http://127.0.0.1:5173/admin/dashboard", waiting until "load"
