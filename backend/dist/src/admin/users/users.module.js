...
exports.AdminUsersModule = AdminUsersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, audit_entity_1.Audit, auditor_audit_assignment_entity_1.AuditorAuditAssignment]),
            audit_trail_module_1.AuditTrailModule,
            notifications_module_1.NotificationsModule,
        ],
        controllers: [users_controller_1.AdminUsersController],
        providers: [users_service_1.AdminUsersService],
        exports: [users_service_1.AdminUsersService],
    })
], AdminUsersModule);
