...
export class AddEngagementChat1711123456794 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "engagement_chat_messages" DROP CONSTRAINT "FK_engagement_chat_author"`,
    );
    await queryRunner.query(
      `ALTER TABLE "engagement_chat_messages" DROP CONSTRAINT "FK_engagement_chat_audit"`,
    );
